...
Now let's get NA rate for each variable
```{r}
print(summarise_all(trips, ~mean(is.na(.))))
```
<br>
...
##### NAs in Station Related Columns
...
##### Data Imputation - Station Ids and Names
Assuming every station name has a corresponding ids, we shall find the missing half of any pair in our dataset.
...
let's now get a count of NAs in both station name and station ids and see if they matched 
```{r}
