...
# Create a reference of unique stations with precisie coordinates
# ==============================================================================
# Below code needs update and refacoring achieve its purpose: 
...
# Add coord_precision to to subset with get_max_precision_decimal function 
stations_combined <- stations_combined %>%
  mutate(
    coord_precision = get_max_precision_decimal(lat, lng),
  )
