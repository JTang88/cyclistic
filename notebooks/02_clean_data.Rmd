...
We will investigate the follwing items in section 3:  
1. Station related columns all have around 15% NAs, suggesting a pattern rather than random  
...
Perform basic statistical analysis on trip durations by rideable type:
```{r}
trip_summary <- trips %>%
