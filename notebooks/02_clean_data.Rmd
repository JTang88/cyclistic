...
trips <- trips %>%
  mutate(start_lat = ifelse(start_coord_precision < 5, add_randomness(med_lat_start), start_lat),
         start_lng = ifelse(start_coord_precision < 5, add_randomness(med_lng_start), start_lng),
         end_lat = ifelse(end_coord_precision < 5, add_randomness(med_lat_end), end_lat),
         end_lng = ifelse(end_coord_precision < 5, add_randomness(med_lng_end), end_lng))
